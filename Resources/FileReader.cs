...
namespace Resources
{
    public class FileReader
    {
        ...
        public static FileDescriptor Read(Stream stream)
        {
            ...
            Logger.Debug("Resources signature was read:");
            ...
            Logger.Debug("Resources header was read:");
            Logger.Debug("Version: {0}, ResourcesCount: {1}", header.Version, header.ResourcesCount);
