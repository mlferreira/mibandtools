...
namespace Resources.Image
{
    public class Reader
    {
        ...
        {
            Logger.Debug("Reading image header...");
            ...
            Logger.Debug("Image header was read:");
            Logger.Debug("Width: {0}, Height: {1}, RowLength: {2}", _width, _height, _rowLengthInBytes);
            Logger.Debug("BPP: {0}, PaletteColors: {1}, Transaparency: {2}",
        ...
        private void ReadPalette()
        {
            ...
            for (var i = 0; i < _paletteColors; i++)
            {
                ...
                if (isColorValid)
                    Logger.Debug("Palette item {0}: R {1:X2}, G {2:X2}, B {3:X2}", i, r, g, b);
                else
